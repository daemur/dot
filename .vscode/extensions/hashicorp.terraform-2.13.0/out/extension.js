...
function startClients(folders = vscodeUtils_1.prunedFolderNames()) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        firstClient.client.onReady().then(() => {
            ...
            const multiFoldersSupported = (_b = (_a = firstClient.client.initializeResult.capabilities.workspace) === null || _a === void 0 ? void 0 : _a.workspaceFolders) === null || _b === void 0 ? void 0 : _b.supported;
...
function configureClient(binPath, folder) {
